# Project Atlas — Development Playbook v1.0.1

> **Document ID:** PA-DF-DOC-000  
> **Versione:** 1.0.1  
> **Stato:** Approval Candidate  
> **Progetto:** Project Atlas — Development Framework  
> **Owner congiunti:** Product Owner e Chief Architect & CTO  
> **Approvatori obbligatori:** Andrea (Product Owner) + ChatGPT (Chief Architect & CTO)  
> **Data di emissione:** 2026-07-15  
...
> **Il Development Playbook può essere modificato soltanto con approvazione congiunta del Product Owner, Andrea, e del Chief Architect & CTO, ChatGPT.**

Gemini, Claude, Codex o qualunque altro agente possono proporre modifiche mediante RFC, ma non possono approvarle, applicarle come regola vigente o dichiararle operative.
...
7. permettere a Gemini di orchestrare Claude e Codex senza reinterpretare la Documentation Bible;
8. fornire a ChatGPT pacchetti di review completi e non conversazioni frammentarie;
...
La versione 1.0 può essere approvata come manuale operativo prima della Frozen Baseline, ma diventa **vincolante per l’implementazione** solo quando il `Baseline Binding Record` riporta:
...
- **operational orchestration:** Gemini in Antigravity;
- **frontend implementation:** Claude;
- **backend and infrastructure implementation:** Codex.
...
- coordinare direttamente Claude o Codex;
- risolvere divergenze tecniche tra agenti;
- sostituire i quality gate tecnici.

## 01.3 Chief Architect & CTO — ChatGPT

### Mandato

ChatGPT è l’autorità architetturale e di governance tecnica. Traduce la baseline in direzione esecutiva, governa milestone e Blueprint, prende decisioni tecniche di livello appropriato e determina se un risultato è conforme all’architettura.
...
- comunicare operativamente soltanto con Gemini;
- approvare congiuntamente le modifiche al Playbook.
...
- non gestisce direttamente task quotidiani di Claude o Codex;
- non salta Gemini per impartire istruzioni operative;
...
## 01.4 Technical Program Manager — Gemini in Antigravity

### Mandato

Gemini è l’unico punto di contatto operativo con il Chief Architect & CTO e l’orchestratore quotidiano del lavoro di Claude e Codex.

### Responsabilità

- trasformare milestone e Blueprint in sprint e task packet;
- pianificare capacità, sequenza e dipendenze;
- assegnare lavoro a Claude e Codex;
...
- produrre il Milestone Review Pack per ChatGPT;
...
Gemini può decidere autonomamente:

- sequenza interna di task già approvati;
- ripartizione operativa tra Claude e Codex entro i confini di ruolo;
...
## 01.5 Senior Frontend Engineer — Claude

### Mandato

Claude implementa il frontend nel rispetto del Blueprint, del Design System, dei contratti e dei task packet approvati.
...
- segnalare ambiguità e rischi a Gemini;
- collaborare indirettamente con Codex tramite contratti e coordinamento Gemini.
...
- comunicare direttamente con ChatGPT o Andrea per ottenere decisioni operative;
- effettuare merge autonomi su `main`;
- occultare workaround o debito tecnico.

## 01.6 Senior Backend & Infrastructure Engineer — Codex

### Mandato

Codex implementa backend, dati, Supabase, infrastruttura, CI/CD e Compute Worker nel rispetto del Blueprint e degli ADR.
...
- segnalare ambiguità e rischi a Gemini;
- coordinare contratti con Claude attraverso Gemini.
...
- comunicare direttamente con ChatGPT o Andrea per decisioni operative;
- effettuare merge autonomi su `main`.

## 01.7 RACI sintetica

| Attività | Andrea | ChatGPT | Gemini | Claude | Codex |
|---|---|---|---|---|---|
...
`R*` indica preparazione della PR; il merge è eseguito soltanto secondo la policy e dopo approvazione Gemini.
...
1. Andrea comunica decisioni e feedback a ChatGPT.
2. ChatGPT invia a Gemini esclusivamente milestone, decisioni, Blueprint e richieste di review.
3. Gemini traduce tali input in istruzioni operative per Claude e Codex.
4. Claude e Codex restituiscono risultati e blocker a Gemini.
5. Gemini filtra, verifica e consolida prima di coinvolgere ChatGPT.
6. ChatGPT riceve pacchetti di milestone o escalation decisionali, non flussi grezzi di sviluppo.
7. Andrea riceve da ChatGPT una sintesi decisionale e le evidenze necessarie all’approvazione business.

## 02.3 Comunicazioni vietate

Sono vietati:

- ordini operativi diretti Andrea → Claude/Codex;
- ordini operativi diretti ChatGPT → Claude/Codex;
- richieste di decisione Claude/Codex → Andrea;
- negoziazioni architetturali dirette tra Claude e Codex senza Gemini;
...
Andrea può materialmente trasferire un Task Packet da Gemini a Claude o Codex, caricare file o copiare output tra strumenti. Questo è **trasporto operativo**, non comunicazione decisionale: il contenuto deve rimanere identico all’artefatto autorizzato e ogni risultato deve tornare a Gemini. Un’istruzione aggiunta durante il trasporto non acquisisce autorità e deve essere ignorata o escalata.
...
Gemini deve fermare e inoltrare a ChatGPT quando:
...
ChatGPT coinvolge Andrea quando la decisione impatta valore, priorità, scope, promessa commerciale, esperienza o rischio business.
...
- la durata può essere ridotta da Gemini se il pacchetto rimane verificabile;
...
- Claude: massimo un task primario `In Progress` e un task di review.
- Codex: massimo un task primario `In Progress` e un task di review.
- Gemini: massimo due stream di integrazione paralleli.
...
↓
ChatGPT Architect Review, quando previsto
↓
...
Una milestone nasce da un insieme di roadmap item già presenti nella baseline. ChatGPT prepara il Milestone Charter con:
...
Andrea approva priorità e valore. Gemini non può avviare la pianificazione prima di tale approvazione.

## 04.2 Blueprint Slice

Per ogni milestone, ChatGPT produce o approva una sezione delimitata del Development Blueprint. Il Blueprint Slice deve essere sufficiente a impedire decisioni architetturali durante l’implementazione.

Se il Blueprint non è sufficiente, Gemini restituisce `Needs Decision`; non colma la lacuna con una propria scelta.
...
Gemini coordina (Merge Policy & QA Integration):
...
- i gate sono passati;
- Gemini ha approvato la Technical Review;
- ChatGPT ha approvato l’Architect Review richiesta;
...
- ChatGPT ha approvato la definizione architetturale.
...
Gemini deve respingere un item incompleto. Iniziare ugualmente non è velocità: è una violazione di governance.
...
- Andrea e ChatGPT hanno fornito le approvazioni richieste;
...
I gate sono condizioni bloccanti, non suggerimenti. Gemini ne verifica l’evidenza; ChatGPT determina quelli architetturali; Andrea approva quelli business.

## 07.2 Gate operativi

| Gate | Scopo | Evidenza minima | Autorità |
|---|---|---|---|
| DP-G00 Authority | confermare che chi decide possieda l’autorità | approval record | Gemini verifica; ChatGPT/Andrea approvano |
| DP-G01 Baseline | impedire scope fuori baseline | requirement + Owner Document | Gemini |
| DP-G02 Blueprint | impedire decisioni in implementazione | Blueprint section | ChatGPT |
| DP-G03 Traceability | collegare requisito, task, PR, test e release | trace links | Gemini |
| DP-G04 Architecture | proteggere ADR, confini e invarianti | architecture checklist | ChatGPT |
| DP-G05 Security & Privacy | prevenire vulnerabilità e accessi impropri | scansioni + review | Gemini; ChatGPT sui rischi alti |
| DP-G06 Data & Migration | proteggere integrità e rollback | migration/restore evidence | Gemini |
| DP-G07 UX & Accessibility | garantire comportamento e accessibilità previsti | test, screenshot, audit | Gemini |
| DP-G08 Performance | rispettare budget e degrado controllato | misure comparative | Gemini |
| DP-G09 Testing | dimostrare correttezza e regressione controllata | test report | Gemini |
| DP-G10 Observability | rendere operabile l’incremento | log/metric/alert evidence | Gemini |
| DP-G11 Integration | verificare contratti e flussi end-to-end | integration report | Gemini |
| DP-G12 Human Accountability | preservare review umana quando richiesta | approval state evidence | ChatGPT/Andrea secondo caso |
| DP-G13 Release Truth | release notes e stato non fuorvianti | release review | ChatGPT + Andrea |
...
Gemini consegna un Milestone Review Pack con:
...
1. ChatGPT verifica completezza del pack.
2. Confronta output con baseline, Blueprint e ADR.
3. Valuta trade-off, debito, compatibilità e rischio.
4. Richiede a Gemini chiarimenti consolidati, non a Claude/Codex direttamente.
...
Gemini è responsabile della Technical Review. Claude e Codex forniscono evidenze e correzioni, ma non approvano il proprio lavoro.
...
- Claude verifica l’usabilità del contratto dal lato client;
- Codex verifica integrità e stabilità del contratto dal lato server;
- Gemini risolve divergenze secondo il Blueprint;
...
Nessun agente implementatore può essere l’unico reviewer del proprio output. Gemini deve esaminare ogni PR prima del merge.
...
Gemini può autorizzare l’integrazione tecnica in preview e dichiarare una PR pronta al merge. Il merge su `main` richiede che siano già presenti tutte le approvazioni indicate dal Milestone Charter:

- Technical Review di Gemini sempre;
- Architect Review di ChatGPT quando la milestone o il task lo richiedono;
...
- le eccezioni richiedono Gemini e ChatGPT.
...
Gemini prepara il Release Candidate Pack:
...
- Gemini certifica readiness tecnica;
- ChatGPT approva conformità architetturale;
...
- test di regressione;
- Gemini review;
- approvazione ChatGPT per impatti architetturali;
- release report;
...
- Gemini può proporre e coordinare una RFC;
- Claude e Codex possono contribuire dati tecnici;
- ChatGPT decide RFC tecniche entro il mandato;
...
Gemini deve richiedere un ADR quando la soluzione implica:
...
2. Gemini prepara contesto ed evidenze;
3. ChatGPT redige o approva l’ADR;
...
2. impact analysis;
3. review Gemini;
4. approvazione congiunta Andrea + ChatGPT;
...
Si aggiorna quando cambia la soluzione tecnica senza modificare il prodotto. ChatGPT è owner; Gemini propone; Claude e Codex forniscono evidenza. Se il cambiamento è architetturale, serve ADR.
...
- non cambia contratti senza Gemini;
...
- è l’unico canale operativo verso ChatGPT.
...
- comunica operativamente con Gemini, non con gli implementatori.
...
- Claude è owner implementativo delle aree frontend assegnate;
- Codex è owner implementativo delle aree backend/infrastruttura assegnate;
- Gemini è owner dell’integrazione e review tecnica;
- ChatGPT è owner dell’architettura;
...
Ogni milestone termina con una retrospective guidata da Gemini, che analizza:
...
Nessun miglioramento è automaticamente normativa. Una modifica al Playbook segue il processo RFC e richiede approvazione congiunta Andrea + ChatGPT.
...
ChatGPT usa le metriche per governance architetturale; Andrea per priorità e rischio business.
...
- [ ] Blueprint Slice approvato da ChatGPT.
...
- [ ] Handoff Report consegnato a Gemini.
...
| Technical Review | verifica coordinata da Gemini |
| Architect Review | verifica architetturale eseguita da ChatGPT |
...
| Decisione | Gemini | ChatGPT | Andrea | Processo |
|---|---|---|---|---|
...
| Chief Architect & CTO | ChatGPT | PENDING | — | — |
