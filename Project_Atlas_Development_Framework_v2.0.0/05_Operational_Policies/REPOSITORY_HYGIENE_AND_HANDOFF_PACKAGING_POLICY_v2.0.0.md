# Repository Hygiene and Handoff Packaging Policy v2.0.0

> **Policy ID:** PA-DF-POL-002
> **Stato:** APPROVED — vincolante
> **Approvazione congiunta:** Andrea, Product Owner + Codex Root, Chief Architect & CTO
> **Data di efficacia:** chiusura M0R
...
Ogni report operativo di Atlas TPM DEVE essere accompagnato da un unico pacchetto ZIP autosufficiente con tutti e soli i file nuovi o modificati necessari per applicare l'handoff. Il messaggio senza ZIP non costituisce consegna verificabile.
...
5. **Delete before create:** Atlas TPM DEVE eliminare il precedente pacchetto `CURRENT` prima di crearne uno nuovo.
...
10. **Message + ZIP:** Andrea trasferisce a Codex Root il messaggio di Atlas TPM e lo ZIP. Codex Root non approva sulla sola descrizione testuale.
...
- `Project_Atlas_Development_Framework_v1.0/` come storico superseded;
- `Project_Atlas_Development_Framework_v2.0.0/` come framework attivo;
...
- `docs/`;
- `scripts/`;
- `AGENTS.md`, `.codex/` e `.agents/` come configurazione Codex-native governata;
- `CLAUDE.md` esclusivamente come bridge non autoritativo verso `AGENTS.md`;
...
- la rimozione definitiva richiede decisione esplicita registrata da Atlas TPM e approvazione conforme all'autorità del file;
...
## 6. Ciclo obbligatorio di handoff Atlas TPM
...
Prima di qualsiasi generazione di codice M-001, Atlas TPM deve:
