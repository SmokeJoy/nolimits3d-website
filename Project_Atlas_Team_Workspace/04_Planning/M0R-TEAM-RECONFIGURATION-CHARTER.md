...
Merge is prohibited until every Role Boundary Test is complete and passing, Atlas TPM has
issued Technical Review, Codex Root has issued Architect Review, and Andrea has recorded
Product Owner acceptance. A green CI run or an open PR cannot substitute for these gates.
